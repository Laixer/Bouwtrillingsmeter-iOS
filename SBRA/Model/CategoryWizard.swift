		...
		get {
			let buildingCategoryQuestions = [
				...
				"Bestaat het pand uit een stalen skelet, glas als gevelbekleding, of hout?\nBijvoorbeeld houten schuurtjes of kantoorgebouwen met grote glazen gevels"
					...
					return WizardQuestion(text: String(s[0]), secondaryText: secondary)
			}
			...
			vibrationCategoryQuestions[2].negativeNext = WizardOutcome(text: "Er is geen kwalificatie van het type trilling kunnen maken",
																	   isPositive: false)
